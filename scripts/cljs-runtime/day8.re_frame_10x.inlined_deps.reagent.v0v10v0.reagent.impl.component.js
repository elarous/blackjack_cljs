...
if((i < len)){
var k = (ks[i]);
var G__32183 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__32184 = (i + (1));
m = G__32183;
i = G__32184;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__31995 = c;
var G__31995__$1 = (((G__31995 == null))?null:G__31995.prototype);
if((G__31995__$1 == null)){
return null;
} else {
return G__31995__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32003 = c;
var G__32003__$1 = (((G__32003 == null))?null:G__32003.prototype);
if((G__32003__$1 == null)){
return null;
} else {
return G__32003__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__32236__delegate = function (args){
var G__32038 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__32038) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component.as_element.call(null,G__32038));
};
...
while (G__32239__i < G__32239__a.length) {G__32239__a[G__32239__i] = arguments[G__32239__i + 0]; ++G__32239__i;}
  args = new cljs.core.IndexedSeq(G__32239__a,0,null);
} 
return G__32236__delegate.call(this,args);};
G__32236.cljs$lang$maxFixedArity = 0;
G__32236.cljs$lang$applyTo = (function (arglist__32240){
var args = cljs.core.seq(arglist__32240);
return G__32236__delegate(args);
});
...
var G__32042 = c;
var G__32042__$1 = (((G__32042 == null))?null:G__32042.constructor);
if((G__32042__$1 == null)){
return null;
} else {
return G__32042__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__32047 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32048 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32048);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32047);
}});
...
var c = this;
var G__32095_32271 = goog.object.get(c,"cljsRatom");
if((G__32095_32271 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.dispose_BANG_(G__32095_32271);
}
...
var renders_32288 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_32289 = cljs.core.first(cljs.core.vals(renders_32288));
...
if((cljs.core.count(renders_32288) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32288))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32289)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32289], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__32128 = o;
goog.object.set(G__32128,cljs.core.name(k),v);
