...
var G__35258 = clojure.zip.node(loc);
var fexpr__35257 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__35262 = clojure.zip.node(loc);
var fexpr__35261 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__35264 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__35264.cljs$core$IFn$_invoke$arity$2 ? fexpr__35264.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__35264.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__35279 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35279,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35279,(1),null);
var vec__35282 = clojure.zip.children(loc);
...
var vec__35291 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35291,(0),null);
var map__35294 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35291,(1),null);
...
var path = map__35294__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35294__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35294__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35294__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35294__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35294__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var map__35305 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35302,(1),null);
...
var path = map__35305__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35305__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__35306 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35305__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__35307 = cljs.core.seq(vec__35306);
var first__35308 = cljs.core.first(seq__35307);
var seq__35307__$1 = cljs.core.next(seq__35307);
var r = first__35308;
var rnext = seq__35307__$1;
var rs = vec__35306;
...
var vec__35316 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35316,(0),null);
var map__35319 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35316,(1),null);
...
var path = map__35319__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35319__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35319__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return r;
} else {
...
var vec__35321 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35321,(0),null);
var map__35324 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35321,(1),null);
...
var path = map__35324__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35324__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35324__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var vec__35326 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35326,(0),null);
var map__35329 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35326,(1),null);
...
var path = map__35329__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35329__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35329__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__35334 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35334,(0),null);
var map__35337 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35334,(1),null);
...
var path = map__35337__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35337__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var map__35342 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35339,(1),null);
...
var path = map__35342__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35342__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__35347 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35347,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35347,(1),null);
...
var G__35453 = (i__4737__auto___35451 + (1));
i__4737__auto___35451 = G__35453;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq35350){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35351,G__35352,seq35350__$2);
}));
...
var G__35467 = clojure.zip.rightmost(child);
loc__$1 = G__35467;
continue;
} else {
return loc__$1;
...
var vec__35361 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35361,(0),null);
var map__35364 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35361,(1),null);
...
var path = map__35364__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35364__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35364__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35364__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35364__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__35476 = clojure.zip.rightmost(child);
loc__$1 = G__35476;
continue;
} else {
return loc__$1;
