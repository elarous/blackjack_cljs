...
var G__38080 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","load-epoch","epochs/load-epoch",166872985),id], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__38080) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__38080));
...
var all_events = cljs.core.deref((function (){var G__38087 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","all-events-by-id","epochs/all-events-by-id",-1225664812)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__38087) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__38087));
})());
var current_id = cljs.core.deref((function (){var G__38088 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__38088) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__38088));
})());
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4529__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__38089(s__38090){
...
var c__4527__auto__ = cljs.core.chunk_first(s__38090__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__38092 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__38091 = (0);
while(true){
if((i__38091 < size__4528__auto__)){
var vec__38096 = cljs.core._nth(c__4527__auto__,i__38091);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38096,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38096,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__38092,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__38119 = (i__38091 + (1));
i__38091 = G__38119;
continue;
} else {
var G__38120 = (i__38091 + (1));
i__38091 = G__38120;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38092),day8$re_frame_10x$view$history$render_$_iter__38089(cljs.core.chunk_rest(s__38090__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38092),null);
}
} else {
var vec__38099 = cljs.core.first(s__38090__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38099,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38099,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__38089(cljs.core.rest(s__38090__$2)));
} else {
var G__38121 = cljs.core.rest(s__38090__$2);
s__38090__$1 = G__38121;
continue;
}
}
} else {
