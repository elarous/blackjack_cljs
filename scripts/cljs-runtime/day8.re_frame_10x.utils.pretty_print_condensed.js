...
var day8$re_frame_10x$utils$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_36014 = (function (x){
...
return day8$re_frame_10x$utils$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_36014(x);
}
});
...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__35933 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35924__$1)].join('')));
...
var G__36029 = clojure.string.replace(s,match,trunc_prefix);
var G__36030 = limit;
var G__36031 = match;
var G__36032 = trunc_prefix;
s = G__36029;
limit = G__36030;
match = G__36031;
trunc_prefix = G__36032;
continue;
}
}
break;
...
var prefix = (function (){var G__35945 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__35945,"\u2026/"].join('');
} else {
return G__35945;
}
})();
...
var vec__35960 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35960,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35960,(1),null);
...
var or__4126__auto__ = (function (){var G__35974 = form.name;
if((G__35974 == null)){
return null;
} else {
return clojure.string.replace(G__35974,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__35989 = obj;
var G__35990 = writer;
var G__35991 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__35989,G__35990,G__35991) : alt_impl.call(null,G__35989,G__35990,G__35991));
} else {
...
var seq__35995 = cljs.core.seq(cljs.core.next(objs));
var chunk__35996 = null;
var count__35997 = (0);
var i__35998 = (0);
while(true){
if((i__35998 < count__35997)){
var obj = chunk__35996.cljs$core$IIndexed$_nth$arity$2(null,i__35998);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__36063 = seq__35995;
var G__36064 = chunk__35996;
var G__36065 = count__35997;
var G__36066 = (i__35998 + (1));
seq__35995 = G__36063;
chunk__35996 = G__36064;
count__35997 = G__36065;
i__35998 = G__36066;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__35995);
if(temp__5735__auto__){
var seq__35995__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__35995__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__35995__$1);
var G__36067 = cljs.core.chunk_rest(seq__35995__$1);
var G__36068 = c__4556__auto__;
var G__36069 = cljs.core.count(c__4556__auto__);
var G__36070 = (0);
seq__35995 = G__36067;
chunk__35996 = G__36068;
count__35997 = G__36069;
i__35998 = G__36070;
continue;
} else {
var obj = cljs.core.first(seq__35995__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__36071 = cljs.core.next(seq__35995__$1);
var G__36072 = null;
var G__36073 = (0);
var G__36074 = (0);
seq__35995 = G__36071;
chunk__35996 = G__36072;
count__35997 = G__36073;
i__35998 = G__36074;
continue;
}
} else {
...
/** @this {Function} */
(day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq36005){
var G__36006 = cljs.core.first(seq36005);
var seq36005__$1 = cljs.core.next(seq36005);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36006,seq36005__$1);
}));
