...
var o26940 = temp__5733__auto__;
var temp__5733__auto____$1 = (o26940["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26941 = temp__5733__auto____$1;
return (o26941["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26371__auto__ = f;
return (o__26371__auto__["toString"]).call(o__26371__auto__);
} else {
return "";
}
}catch (e26952){var _ = e26952;
return "";
}});
...
try{var o__26371__auto___27340 = t;
(o__26371__auto___27340["cljs$lang$ctorPrWriter"]).call(o__26371__auto___27340,t,writer);
}catch (e26979){var __27341 = e26979;
}
...
var char_code = (function (){var o__26371__auto__ = (new String(char$));
return (o__26371__auto__["charCodeAt"]).call(o__26371__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26371__auto__ = String;
return (o__26371__auto__["fromCharCode"]).call(o__26371__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27024 = num_code;
switch (G__27024) {
case (1):
return (185);
...
var o__26371__auto__ = String;
return (o__26371__auto__["fromCharCode"]).call(o__26371__auto__,superscript_code);
});
/**
...
}catch (e27066){var _e__26408__auto__ = e27066;
return false;
}})())){
...
var vec__27067 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27067,(0),null);
...
var len__4736__auto___27369 = arguments.length;
var i__4737__auto___27370 = (0);
while(true){
if((i__4737__auto___27370 < len__4736__auto___27369)){
args__4742__auto__.push((arguments[i__4737__auto___27370]));

var G__27371 = (i__4737__auto___27370 + (1));
i__4737__auto___27370 = G__27371;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27085){
var vec__27086 = p__27085;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27086,(0),null);
...
var G__27373 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27374 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27373;
remaining_tokens = G__27374;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27080){
...
var vec__27101 = cljs.core.split_with((function (p1__27100_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27100_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27101,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27101,(1),null);
...
var vec__27110 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27110,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27110,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27380 = cljs.core.rest(remaining_tokens);
var G__27381 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27380;
name_tokens = G__27381;
continue;
} else {
...
var vec__27120 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27120,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27120,(1),null);
var vec__27123 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27123,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27123,(1),null);
var vec__27126 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27126,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27126,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27126,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27126,(3),null);
...
var vec__27145 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27145,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27145,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27145,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27145,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27145,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27145,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27151 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27151,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27151,(1),null);
var vec__27154 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27154,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27154,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27166 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27166) : devtools.munging.parse_fn_info_deep.call(null,G__27166));
})()));
}
} else {
return fn_info;
...
var G__27407 = (arity + (1));
var G__27408 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27174){
var vec__27175 = p__27174;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27175,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27175,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27200_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27200_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27202_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27202_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27215){
var vec__27216 = p__27215;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27216,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27208){
var G__27209 = cljs.core.first(seq27208);
var seq27208__$1 = cljs.core.next(seq27208);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27209,seq27208__$1);
}));
...
var map__27239 = options;
var map__27239__$1 = (((((!((map__27239 == null))))?(((((map__27239.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27239.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27239):map__27239);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27239__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27239__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27239__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27239__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27240 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(5),null);
...
var o__26371__auto__ = f;
return (o__26371__auto__["getBasis"]).call(o__26371__auto__);
});
/**
...
}catch (e27253){var _e__26408__auto__ = e27253;
...
var _STAR_ = (function (accum,p__27288){
var vec__27289 = p__27288;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27289,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27289,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27315){
var vec__27316 = p__27315;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27316,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27316,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27316,(2),null);
...
var post_process = (function (p__27331){
var vec__27332 = p__27331;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27332,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27332,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27325_SHARP_){
return (obj[cljs.core.first(p1__27325_SHARP_)]);
}),sorted_matches);
