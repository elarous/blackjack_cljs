...
var G__27410 = devtools.prefs.pref(v);
v = G__27410;
continue;
} else {
return v;
...
}catch (e27359){var _e__26408__auto__ = e27359;
return false;
}})();
...
}catch (e27364){var _e__26408__auto__ = e27364;
return false;
}})();
...
}catch (e27366){var _e__26408__auto__ = e27366;
return false;
}}
}
});
...
var vec__27384 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__27389_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27389_SHARP_);
}),template);
});
