...
var G__36877 = o;
goog.object.set(G__36877,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36879 = o;
goog.object.set(G__36879,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37006__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37007__i < G__37007__a.length) {G__37007__a[G__37007__i] = arguments[G__37007__i + 0]; ++G__37007__i;}
  args = new cljs.core.IndexedSeq(G__37007__a,0,null);
} 
return G__37006__delegate.call(this,args);};
G__37006.cljs$lang$maxFixedArity = 0;
G__37006.cljs$lang$applyTo = (function (arglist__37008){
var args = cljs.core.seq(arglist__37008);
return G__37006__delegate(args);
});
...
var G__36883 = props;
var G__36883__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36883,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36883);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36883__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__36883__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36886 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36886,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36886;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36892){
...
return (jsprops.onChange = (function (p1__36897_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36897_SHARP_);
}));
} else {
return null;
}
...
var vec__36909 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36909,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36909,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36909,(2),null);
...
var temp__5739__auto___37020 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37020 == null)){
} else {
var key_37021 = temp__5739__auto___37020;
(jsprops.key = key_37021);
}
...
var temp__5739__auto___37022 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37022 == null)){
} else {
var key_37023 = temp__5739__auto___37022;
(jsprops.key = key_37023);
}
...
var G__36926 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36926) : reagent.impl.template.as_element.call(null,G__36926));
} else {
var temp__5739__auto___37029 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___37029 == null)){
} else {
var key_37032 = temp__5739__auto___37029;
(jsprops.key = key_37032);
}
...
var G__36929 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__36929)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__36929)){
return x;
} else {
...
while(true){
if((i__4737__auto___37047 < len__4736__auto___37045)){
args__4742__auto__.push((arguments[i__4737__auto___37047]));

var G__37053 = (i__4737__auto___37047 + (1));
i__4737__auto___37047 = G__37053;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36931){
var G__36932 = cljs.core.first(seq36931);
var seq36931__$1 = cljs.core.next(seq36931);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36932,seq36931__$1);
}));
...
break;
default:
var G__37065 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37065;
continue;
...
var ctx = ({});
var vec__36947 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36947,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36947,(1),null);
...
var G__36951 = (cljs.core.count(argv) - first_child);
switch (G__36951) {
case (0):
