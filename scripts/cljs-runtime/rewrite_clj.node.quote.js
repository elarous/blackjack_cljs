...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k34583,else__4383__auto__){
var self__ = this;
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__34582){
var self__ = this;
var G__34582__$1 = this;
return (new cljs.core.RecordIter((0),G__34582__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__34582){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__34626 = cljs.core.keyword_identical_QMARK_;
var expr__34627 = k__4388__auto__;
if(cljs.core.truth_((pred__34626.cljs$core$IFn$_invoke$arity$2 ? pred__34626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__34627) : pred__34626.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__34627)))){
return (new rewrite_clj.node.quote.QuoteNode(G__34582,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34626.cljs$core$IFn$_invoke$arity$2 ? pred__34626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__34627) : pred__34626.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__34627)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__34582,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34626.cljs$core$IFn$_invoke$arity$2 ? pred__34626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__34627) : pred__34626.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__34627)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__34582,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34626.cljs$core$IFn$_invoke$arity$2 ? pred__34626.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__34627) : pred__34626.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__34627)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__34582,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__34582),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__34582){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__34582,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__34586){
var extmap__4419__auto__ = (function (){var G__34640 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__34586,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__34586)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__34640);
} else {
return G__34640;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__34586),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__34586),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__34586),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__34586),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__34683 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__34683;
continue;
}
break;
...
var G__34685 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__34685;
continue;
}
break;
...
var G__34690 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__34690;
continue;
}
break;
...
var G__34694 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__34694;
continue;
}
break;
