...
var G__35630 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__35630__$1 = (((G__35630 == null))?null:cljs.core.iterate((function (loc){
...
var G__35630__$2 = (((G__35630__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__35630__$1));
var G__35630__$3 = (((G__35630__$2 == null))?null:cljs.core.last(G__35630__$2));
if((G__35630__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__35630__$3);
}
} else {
return zloc;
}
...
var G__35664 = rewrite_clj.zip.move.right(v);
var G__35665 = rewrite_clj.zip.move.up(v);
loc = G__35664;
parent = G__35665;
continue;
} else {
var G__35666 = rewrite_clj.zip.move.right(v0);
var G__35667 = parent;
loc = G__35666;
parent = G__35667;
continue;
...
var G__35674 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__35675 = rewrite_clj.zip.move.up(v);
loc = G__35674;
parent = G__35675;
continue;
} else {
var G__35677 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__35678 = parent;
loc = G__35677;
parent = G__35678;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__35650 = zloc;
var G__35650__$1 = (((G__35650 == null))?null:rewrite_clj.zip.move.down(G__35650));
var G__35650__$2 = (((G__35650__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__35650__$1,k));
if((G__35650__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__35650__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__35651 = rewrite_clj.zip.move.down(zloc);
var G__35651__$1 = (((G__35651 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__35651));
if((G__35651__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__35651__$1);
}
})(),k);
}
});
