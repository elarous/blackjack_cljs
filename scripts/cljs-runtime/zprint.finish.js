...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__34005_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__34005_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__34005_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__34012){
var vec__34013 = p__34012;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34013,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34013,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__34031,s,color,element,idx){
var map__34032 = p__34031;
var map__34032__$1 = (((((!((map__34032 == null))))?(((((map__34032.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34032.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34032):map__34032);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34032__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34032__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34032__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__34040 = (function (){var or__4126__auto__ = color;
...
var fexpr__34039 = (function (){var G__34044 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__34044) : style_map.call(null,G__34044));
})();
return (fexpr__34039.cljs$core$IFn$_invoke$arity$1 ? fexpr__34039.cljs$core$IFn$_invoke$arity$1(G__34040) : fexpr__34039.call(null,G__34040));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__34053){
var vec__34055 = p__34053;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34055,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34055,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34055,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__34062){
var vec__34066 = p__34062;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34066,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34066,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34066,(2),null);
...
var G__34300 = cljs.core.next(ssv);
var G__34301 = (this_ssv == null);
var G__34302 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__34303 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__34300;
doing_nil_QMARK_ = G__34301;
last_elide = G__34302;
out = G__34303;
continue;
}
...
var vec__34089 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34089,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34089,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34089,(2),null);
...
var G__34325 = cljs.core.next(remaining_cvec);
var G__34326 = new_idx;
var G__34327 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__34325;
idx = G__34326;
out = G__34327;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__34108,cursor_vec){
var vec__34109 = p__34108;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34109,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34109,(1),null);
var focus_vec = vec__34109;
...
var vec__34112 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34112,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34112,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__34129){
var vec__34134 = p__34129;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34134,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34134,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__34164,existing_count){
var vec__34165 = p__34164;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34165,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34165,(1),null);
...
return cljs.core.filterv((function (p1__34149_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__34149_SHARP_))));
...
var vec__34211 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34211,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34211,(1),null);
var cvec_element = vec__34211;
if((cvec_element == null)){
var G__34400 = cljs.core.next(cvec_nl);
var G__34401 = (idx + (1));
var G__34402 = start;
var G__34403 = out;
cvec_nl = G__34400;
...
var G__34406 = cljs.core.next(cvec_nl);
var G__34407 = (idx + (1));
var G__34408 = idx;
var G__34409 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__34406;
idx = G__34407;
start = G__34408;
out = G__34409;
...
var G__34413 = cljs.core.next(cvec_nl);
var G__34414 = (idx + (1));
var G__34415 = (idx + (1));
var G__34416 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__34413;
idx = G__34414;
start = G__34415;
out = G__34416;
...
var G__34417 = cljs.core.next(cvec_nl);
var G__34418 = (idx + (1));
var G__34419 = idx;
var G__34420 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__34417;
idx = G__34418;
start = G__34419;
out = G__34420;
...
var G__34422 = cljs.core.next(cvec_nl);
var G__34423 = (idx + (1));
var G__34424 = start;
var G__34425 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__34422;
idx = G__34423;
start = G__34424;
out = G__34425;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34228_SHARP_,p2__34227_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__34227_SHARP_)){
return cljs.core.reduced(p1__34228_SHARP_);
} else {
return (p1__34228_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__34233,p__34234){
var vec__34236 = p__34233;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34236,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34236,(1),null);
var vec__34239 = p__34234;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34239,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34239,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__34251,cvec,focus_vec){
...
var options = map__34252__$1;
var map__34253 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34252__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__34253__$1 = (((((!((map__34253 == null))))?(((((map__34253.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34253.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34253):map__34253);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34253__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34253__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34253__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34249_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__34249_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
