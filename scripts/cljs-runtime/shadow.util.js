...
var i__4737__auto___42150 = (0);
while(true){
if((i__4737__auto___42150 < len__4736__auto___42149)){
args_arr__4757__auto__.push((arguments[i__4737__auto___42150]));

var G__42151 = (i__4737__auto___42150 + (1));
i__4737__auto___42150 = G__42151;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq42097){
var G__42098 = cljs.core.first(seq42097);
var seq42097__$1 = cljs.core.next(seq42097);
var G__42099 = cljs.core.first(seq42097__$1);
var seq42097__$2 = cljs.core.next(seq42097__$1);
var G__42100 = cljs.core.first(seq42097__$2);
var seq42097__$3 = cljs.core.next(seq42097__$2);
var G__42101 = cljs.core.first(seq42097__$3);
var seq42097__$4 = cljs.core.next(seq42097__$3);
var G__42102 = cljs.core.first(seq42097__$4);
var seq42097__$5 = cljs.core.next(seq42097__$4);
var G__42103 = cljs.core.first(seq42097__$5);
var seq42097__$6 = cljs.core.next(seq42097__$5);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42098,G__42099,G__42100,G__42101,G__42102,G__42103,seq42097__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__42125){
var vec__42127 = p__42125;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42127,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42127,(1),null);
