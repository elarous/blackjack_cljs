 ...
 */
garden.units.convert = (function garden$units$convert(p__29353,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29354__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29354__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__29387 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29387,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29387,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29387,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29421__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29422 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29422__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__29596__delegate = function (x,y,more){
...
var G__29597__i = 0, G__29597__a = new Array(arguments.length -  2);
while (G__29597__i < G__29597__a.length) {G__29597__a[G__29597__i] = arguments[G__29597__i + 2]; ++G__29597__i;}
  more = new cljs.core.IndexedSeq(G__29597__a,0,null);
} 
...
var x = cljs.core.first(arglist__29598);
arglist__29598 = cljs.core.next(arglist__29598);
var y = cljs.core.first(arglist__29598);
var more = cljs.core.rest(arglist__29598);
...
var G__29599 = null;
if (arguments.length > 2) {
var G__29600__i = 0, G__29600__a = new Array(arguments.length -  2);
while (G__29600__i < G__29600__a.length) {G__29600__a[G__29600__i] = arguments[G__29600__i + 2]; ++G__29600__i;}
G__29599 = new cljs.core.IndexedSeq(G__29600__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29599);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29446__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29447 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29447__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__29601__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__29602__i = 0, G__29602__a = new Array(arguments.length -  2);
while (G__29602__i < G__29602__a.length) {G__29602__a[G__29602__i] = arguments[G__29602__i + 2]; ++G__29602__i;}
  more = new cljs.core.IndexedSeq(G__29602__a,0,null);
} 
...
var G__29604 = null;
if (arguments.length > 2) {
var G__29605__i = 0, G__29605__a = new Array(arguments.length -  2);
while (G__29605__i < G__29605__a.length) {G__29605__a[G__29605__i] = arguments[G__29605__i + 2]; ++G__29605__i;}
G__29604 = new cljs.core.IndexedSeq(G__29605__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29604);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__29470 = u(x);
var map__29470__$1 = (((((!((map__29470 == null))))?(((((map__29470.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29470.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29470):map__29470);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29470__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29471 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29471__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__29609__delegate = function (x,y,more){
...
while (G__29610__i < G__29610__a.length) {G__29610__a[G__29610__i] = arguments[G__29610__i + 2]; ++G__29610__i;}
  more = new cljs.core.IndexedSeq(G__29610__a,0,null);
} 
...
while (G__29613__i < G__29613__a.length) {G__29613__a[G__29613__i] = arguments[G__29613__i + 2]; ++G__29613__i;}
G__29612 = new cljs.core.IndexedSeq(G__29613__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29612);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29492__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__29493 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29493__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__29615__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__29616__i = 0, G__29616__a = new Array(arguments.length -  2);
while (G__29616__i < G__29616__a.length) {G__29616__a[G__29616__i] = arguments[G__29616__i + 2]; ++G__29616__i;}
  more = new cljs.core.IndexedSeq(G__29616__a,0,null);
} 
...
var G__29618 = null;
if (arguments.length > 2) {
var G__29619__i = 0, G__29619__a = new Array(arguments.length -  2);
while (G__29619__i < G__29619__a.length) {G__29619__a[G__29619__i] = arguments[G__29619__i + 2]; ++G__29619__i;}
G__29618 = new cljs.core.IndexedSeq(G__29619__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__29618);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
