...
var vec__39035 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__39038 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39038,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39038,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39035,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39035,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__39043){
var vec__39046 = p__39043;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39046,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39046,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39052,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39052,(1),null);
...
var vec__39068 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39068,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39068,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39068,(2),null);
var vec__39071 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39071,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39071,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39071,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__39080){
var vec__39082 = p__39080;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39082,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39082,(1),null);
...
var vec__39093 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39093,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39093,(1),null);
...
var G__39096 = zprint.core.parse_string_all_options(rest_options);
var G__39097 = zprint.core.zprint_str_internal;
var G__39098 = ":parse-string-all? call";
var G__39099 = (function (){var G__39100 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39100) : zprint.zutil.edn_STAR_.call(null,G__39100));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__39096,G__39097,G__39098,G__39099) : zprint.core.process_multiple_forms.call(null,G__39096,G__39097,G__39098,G__39099));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__39101 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39101,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39101,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq39090){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39091,G__39092,seq39090__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___39267 = arguments.length;
var i__4737__auto___39268 = (0);
while(true){
if((i__4737__auto___39268 < len__4736__auto___39267)){
args__4742__auto__.push((arguments[i__4737__auto___39268]));

var G__39269 = (i__4737__auto___39268 + (1));
i__4737__auto___39268 = G__39269;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq39107){
...
var args__4742__auto__ = [];
var len__4736__auto___39280 = arguments.length;
var i__4737__auto___39281 = (0);
while(true){
if((i__4737__auto___39281 < len__4736__auto___39280)){
args__4742__auto__.push((arguments[i__4737__auto___39281]));

var G__39286 = (i__4737__auto___39281 + (1));
i__4737__auto___39281 = G__39286;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq39109){
...
var args__4742__auto__ = [];
var len__4736__auto___39303 = arguments.length;
var i__4737__auto___39304 = (0);
while(true){
if((i__4737__auto___39304 < len__4736__auto___39303)){
args__4742__auto__.push((arguments[i__4737__auto___39304]));

var G__39305 = (i__4737__auto___39304 + (1));
i__4737__auto___39304 = G__39305;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq39111){
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq39113){
var G__39114 = cljs.core.first(seq39113);
var seq39113__$1 = cljs.core.next(seq39113);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39114,seq39113__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__39117,form){
var vec__39118 = p__39117;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39118,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39118,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39118,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39118,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__39122 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39122,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39122,(1),null);
...
var forms = (function (){var G__39132 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39132) : zprint.zutil.edn_STAR_.call(null,G__39132));
})();
