...
if((i < len)){
var k = (ks[i]);
var G__36858 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36859 = (i + (1));
m = G__36858;
i = G__36859;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36728 = c;
var G__36728__$1 = (((G__36728 == null))?null:G__36728.prototype);
if((G__36728__$1 == null)){
return null;
} else {
return G__36728__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36733 = c;
var G__36733__$1 = (((G__36733 == null))?null:G__36733.prototype);
if((G__36733__$1 == null)){
return null;
} else {
return G__36733__$1.render;
}
})() == null)))));
});
...
var G__36748 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36748) : reagent.impl.component.as_element.call(null,G__36748));
};
...
var G__36749 = c;
var G__36749__$1 = (((G__36749 == null))?null:G__36749.constructor);
if((G__36749__$1 == null)){
return null;
} else {
return G__36749__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__36751 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36752 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36752);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36751);
}});
...
var c = this;
var G__36799_36880 = goog.object.get(c,"cljsRatom");
if((G__36799_36880 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36799_36880);
}
...
var renders_36884 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36885 = cljs.core.first(cljs.core.vals(renders_36884));
...
if((cljs.core.count(renders_36884) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36884))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36885)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36885], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36843 = o;
goog.object.set(G__36843,cljs.core.name(k),v);
