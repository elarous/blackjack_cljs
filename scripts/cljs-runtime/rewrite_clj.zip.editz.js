...
var G__35524 = (function (){var G__35526 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__35526) : f.call(null,G__35526));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__35524) : rewrite_clj.node.coerce.call(null,G__35524));
});
/**
...
while(true){
if((i__4737__auto___35593 < len__4736__auto___35591)){
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__35528_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__35528_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq35529){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35530,G__35531,seq35529__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__35555 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__35555) : str_fn.call(null,G__35555));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__35559 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__35559) : str_fn.call(null,G__35559));
})()):null)));
...
var G__35575 = rewrite_clj.zip.base.tag(zloc);
var G__35575__$1 = (((G__35575 instanceof cljs.core.Keyword))?G__35575.fqn:null);
switch (G__35575__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__35570_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__35570_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__35571_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__35571_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35575__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__35586 = rewrite_clj.zip.base.tag(zloc);
var G__35586__$1 = (((G__35586 instanceof cljs.core.Keyword))?G__35586.fqn:null);
switch (G__35586__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__35583_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__35583_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
