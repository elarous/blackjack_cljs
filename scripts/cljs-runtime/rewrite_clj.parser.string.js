...
if((c === "\n")){
var G__35206 = escape_QMARK_;
var G__35207 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__35206;
lines = G__35207;
continue;
} else {
buf.append(c);

var G__35208 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__35209 = lines;
escape_QMARK_ = G__35208;
lines = G__35209;
continue;
...
var G__35201 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__35201) : rewrite_clj.node.string_node.call(null,G__35201));
});
...
var G__35202 = cljs.core.re_pattern(regex);
var G__35203 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__35202,G__35203) : rewrite_clj.node.token_node.call(null,G__35202,G__35203));
});
